  ...
  <div class="card-body">
    <form action="/pegawai/store" method="POST">
      ...
      <div class="form-group col-8">
        ...
        <input type="text" name="kode_pegawai" class="form-control @error('kode_pegawai') is-invalid @enderror" id="kode_pegawai" placeholder="Kode Pegawai" value="{{ $id }}" readonly>
        @error('kode_pegawai')
