  ...
  <div class="card-body">
    <form action="/barang_masuk/update/{{ $product->id }}" method="POST">
      ...
      <div class="form-group col-8">
        ...
        <input type="text" name="nama_barang" class="form-control @error('nama_barang') is-invalid @enderror" id="nama_barang" placeholder="Nama Barang" value="{!! $product->nama_barang !!}" readonly>
        @error('nama_barang')
